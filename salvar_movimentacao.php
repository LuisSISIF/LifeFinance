...
/*
|--------------------------------------------------------------------------
| Salvamento de movimentação com impacto em saldo
|--------------------------------------------------------------------------
| Este arquivo insere uma movimentação e, quando necessário,
| atualiza o saldo das contas relacionadas dentro de uma transação.
*/
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    | Usuário autenticado
    |--------------------------------------------------------------------------
    | O sistema usa o ID da sessão para vincular a movimentação ao usuário.
    */
    ...
    */
    ...
    try {
        ...
        */
        ...
        |--------------------------------------------------------------------------
        | Só ocorre quando o lançamento estiver como PAGO.
        */
        if ($status === 'PAGO') {
            if ($tipo === 'RECEITA') {
